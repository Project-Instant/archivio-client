          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 w-full max-w-md">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="w-full pl-10 bg-white/90 h-12 text-black"
              />
            </div>
            <Button className="h-12 px-6 bg-black text-white border-white hover:bg-white hover:text-black transition-colors">
              Explore
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="h-12 px-8 text-white hover:bg-white/10">
                Learn more
              </Button>
            </div>
          </div>

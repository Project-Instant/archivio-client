...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 border-b-muted/20 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
    ...
    <SheetPrimitive.Content className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      {withClose && (
        <SheetPrimitive.Close
          className={`absolute right-4 top-4 rounded-xs opacity-70 
